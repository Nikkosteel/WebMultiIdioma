var WebMultiLanguage = WebMultiLanguage || {};

WebMultiLanguage.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = WebMultiLanguage;

    // excluding the parent
    if (namespaceArr[0] === 'WebMultiLanguage') {
...
WebMultiLanguage.createNameSpace("WebMultiLanguage.Cookies");

WebMultiLanguage.Cookies.getCookie = function (ck_name) {
...
WebMultiLanguage.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
